        ...
        <body ng-app="myApp" class="ng-cloak bg-light">
            <div
                ...
                <nav class="my-2 my-md-0 mr-md-3">
                    <a class="p-2 text-dark" href="/landingpage" id="homeLink">Home</a>
                </nav>
            </div>
            <main>
                            ...
                            <form ng-submit="pokemonController.submit()" name="myForm" class="form-horizontal">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" ng-model="pokemonController.pokemon.name" name="name"
                                                ...
                                                required ng-minlength="3" id="pokemonNameInput" />
                                            <div class="has-error" ng-show="myForm.$dirty">
                                                <span ng-show="myForm.name.$error.required">This is a required
                                                    field</span>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-md-7">
                                            <input type="number" ng-model="pokemonController.pokemon.defense"
                                                name="defense" class="defense form-control input-sm"
            ...
            <script src="/static/js/service/pokemon_service.js"></script>
            <script src="/static/js/controller/pokemon_controller.js"></script>
        </body>
